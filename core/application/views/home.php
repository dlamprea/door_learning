...
<head>
	...
	<link href="<?php echo site_url('common/bootstrap/extend/bootstrap-wysihtml5/css/bootstrap-wysihtml5-0.0.2.css')?>" rel="stylesheet">
	<link href="<?php echo site_url('common/bootstrap/extend/bootstrap-select/bootstrap-select.css')?>" rel="stylesheet" />
	<link href="<?php echo site_url('common/bootstrap/extend/bootstrap-switch/static/stylesheets/bootstrap-switch.css')?>" rel="stylesheet" />
	
	<!-- DateTimePicker Plugin -->
	<link href="<?php echo site_url('common/theme/scripts/plugins/forms/bootstrap-datetimepicker/css/datetimepicker.css')?>" rel="stylesheet" />
	
	<!-- JQueryUI -->
	<link href="<?php echo site_url('common/theme/scripts/plugins/system/jquery-ui/css/smoothness/jquery-ui-1.9.2.custom.min.css')?>" rel="stylesheet" />
	
	<!-- MiniColors ColorPicker Plugin -->
	<link href="<?php echo site_url('common/theme/scripts/plugins/color/jquery-miniColors/jquery.miniColors.css')?>" rel="stylesheet" />
	
	<!-- Notyfy Notifications Plugin -->
	<link href="<?php echo site_url('common/theme/scripts/plugins/notifications/notyfy/jquery.notyfy.css')?>" rel="stylesheet" />
	<link href="<?php echo site_url('common/theme/scripts/plugins/notifications/notyfy/themes/default.css')?>" rel="stylesheet" />
	
	<!-- Gritter Notifications Plugin -->
	<link href="<?php echo site_url('common/theme/scripts/plugins/notifications/Gritter/css/jquery.gritter.css')?>" rel="stylesheet" />
	
	<!-- Easy-pie Plugin -->
	<link href="<?php echo site_url('common/theme/scripts/plugins/charts/easy-pie/jquery.easy-pie-chart.css')?>" rel="stylesheet" />

	<!-- Google Code Prettify Plugin -->
	<link href="<?php echo site_url('common/theme/scripts/plugins/other/google-code-prettify/prettify.css')?>" rel="stylesheet" />
...
<body class="document-body ">
	...
	<div class="container-fluid menu-hidden sidebar-hidden-phone fluid menu-left">
		...
		<div id="menu" class="hidden-print">
			...
			<!-- Brand -->
			<a href="index.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible" class="appbrand"><span class="text-primary">FLAT</span> <span>KIT</span></a>
			...
			<div class="slim-scroll" data-scroll-height="800px">
				...
				<span class="profile center">
					<a href="my_account_advanced.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible"><img src="<?php echo site_url('common/theme/images/avatar-74x74.jpg')?>" alt="Avatar" /></a>
				</span>
				<!-- // Sidebar Profile END -->
				...
				<ul>
					...
					<li class="active"><a href="index.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible" class="glyphicons dashboard"><i></i><span>Dashboard</span></a></li>
<li class="hasSubmenu">
	...
	<ul class="collapse" id="menu_components">
		...
		<li class="hasSubmenu">
			...
			<ul class="collapse" id="menu_components_forms">
				<li class=""><a href="form_wizards.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Form Wizards</a></li>
				<li class=""><a href="form_elements.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Form Elements</a></li>
				<li class=""><a href="form_validator.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Form Validator</a></li>
				<li class=""><a href="file_managers.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">File Managers</a></li>
			</ul>
		</li>
		...
		<li class="hasSubmenu">
			...
			<ul class="collapse" id="menu_components_tables">
				<li class=""><a href="tables.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Tables</a></li>
				<li class=""><a href="tables_responsive.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Responsive Tables</a></li>
				<li class=""><a href="pricing_tables.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Pricing tables</a></li>
			</ul>
		</li>
		
		<!-- Components Submenu Regular Items -->
		<li class=""><a href="ui.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">UI Elements</a></li>
		<li class=""><a href="icons.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Icons</a></li>
		<li class=""><a href="widgets.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Widgets</a></li>
		<li class=""><a href="tabs.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Tabs</a></li>
		<li class=""><a href="sliders.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Sliders</a></li>
		<li class=""><a href="charts.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Charts</a></li>
		<li class=""><a href="grid.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Grid system</a></li>
		<li class=""><a href="notifications.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Notifications</span></a></li>
		<li class=""><a href="modals.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Modals</a></li>
		<li class=""><a href="thumbnails.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Thumbnails</a></li>
		<li class=""><a href="carousels.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Carousels</a></li>
		<li class=""><a href="image_crop.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Image Cropping</a></li>
		<li class=""><a href="tour.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Page Tour</a></li>
		...
		<li class="hasSubmenu">
			...
			<ul class="collapse" id="menu_components_api">
				<li class=""><a href="twitter.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Twitter API</a></li>
				<li class=""><a href="google_analytics.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Google Analytics API</a></li>
			</ul>
		</li>
		
		<li class=""><a href="infinite_scroll.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Infinite Scroll</a></li>
...
<li class="hasSubmenu">
	...
	<ul class="collapse" id="menu_pages">
		...
		<li><a href="timeline.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible" class="glyphicons history"><i></i>Timeline</a></li>
		<li><a href="employees.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible" class="glyphicons group"><i></i>Employees</a></li>
			...
			<ul class="collapse" id="menu_pages_front">
				<li><a class="no-ajaxify" href="../front/index_slider.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Revolution Slider Fixed</a></li>
				<li><a class="no-ajaxify" href="../front/index_slider_fullwidth.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Revolution Slider Wide</a></li>
				<li><a class="no-ajaxify" href="../front/index.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Home page #1</a></li>
				<li><a class="no-ajaxify" href="../front/index_2.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Home page #2</a></li>
				<li><a class="no-ajaxify" href="../front/about.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">About us</a></li>
				<li><a class="no-ajaxify" href="../front/pricing.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Pricing</a></li>
				<li><a class="no-ajaxify" href="../front/blog.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Blog</a></li>
				<li><a class="no-ajaxify" href="../front/blog_timeline.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Blog Timeline</a></li>
				<li><a class="no-ajaxify" href="../front/shop.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Shop Catalog</a></li>
				<li><a class="no-ajaxify" href="../front/shop_product.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Shop Product</a></li>
				<li><a class="no-ajaxify" href="../front/shop_cart.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Shopping Cart</a></li>
				<li><a class="no-ajaxify" href="../front/contact.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Contact</a></li>
				<li><a class="no-ajaxify" href="../front/login.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Login</a></li>
				<li><a class="no-ajaxify" href="../front/signup.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Sign up</a></li>
				<li><a class="no-ajaxify" href="../front/error.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Error page</a></li>
			</ul>
		</li>
				
		<li><a href="invoice.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible" class="glyphicons credit_card"><i></i>Invoice</a></li>
		<li><a href="faq.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible" class="glyphicons circle_question_mark"><i></i>FAQ</a></li>
		<li><a href="search.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible" class="glyphicons search"><i></i>Search</a></li>
		<li><a href="ratings.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible" class="glyphicons star"><i></i>Ratings</a></li>
		...
		<li class="hasSubmenu">
			...
			<ul class="collapse" id="menu_pages_account">
				<li class=""><a href="my_account_advanced.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Advanced profile</a></li>
				<li class=""><a href="my_account.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">My Account</a></li>
				<li><a href="login.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible"><i></i>Login</a></li>
				<li><a href="signup.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible"><i></i>Register</a></li>
			</ul>
		</li>
		<li class="hasSubmenu">
			...
			<ul class="collapse" id="menu_pages_maps">
				<li class=""><a href="maps_vector.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Vector maps</a></li>
				<li class=""><a href="maps_google.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Google maps</a></li>
			</ul>
		</li>
		<li class="hasSubmenu">
			...
			<ul class="collapse" id="menu_pages_shop">
				<li class=""><a href="shop_products.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Products</a></li>
				<li class=""><a href="shop_edit_product.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Add product</a></li>
				<li class=""><a href="shop_orders_timeline.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Orders Timeline</a></li>
			</ul>
		</li>
		<li><a href="typography.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible" class="glyphicons font"><i></i>Typography</a></li>
		<li><a href="gallery.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible" class="glyphicons picture"><i></i>Photo Gallery</a></li>
		<li><a href="calendar.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible" class="glyphicons calendar"><i></i>Calendar</a></li>
		<li><a href="bookings.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible" class="glyphicons user_add"><i></i>Bookings</a></li>
		<li><a href="finances.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible" class="glyphicons coins"><i></i>Finances</a></li>
		<li><a href="error.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible" class="glyphicons warning_sign"><i></i>Error page</a></li>
		<li><a href="blank.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible" class="glyphicons magic"><i></i>Blank page</a></li>
	</ul>
</li>					
				</ul>
		...
		<div class="navbar main hidden-print">
			...
			<ul class="topnav pull-left">
				<li class="active"><a href="index.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible" class="glyphicons dashboard"><i></i> Dashboard</a></li>
				...
				<li class="dropdown dd-1">
					...
					<ul class="dropdown-menu pull-left">
						<li><a href="social.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible" class="glyphicons star"><i></i>Social</a></li>
						...
						<li class="dropdown submenu">
							...
							<ul class="dropdown-menu submenu-show submenu-hide pull-right">
								<li class=""><a class="no-ajaxify" href="maps_vector.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Vector maps</a></li>
								<li class=""><a class="no-ajaxify" href="maps_google.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible">Google maps</a></li>
							</ul>
						</li>
						<li class="dropdown submenu">
			...
			<ul class="topnav pull-right hidden-sm">
				...
				<li class="hidden-xs dropdown dd-1 dd-flags" id="lang_nav">
					<a href="#" data-toggle="dropdown"><img src="<?php echo site_url('common/theme/images/lang/en.png')?>" alt="en" /></a>
			    	<ul class="dropdown-menu pull-right">
			      		<li class="active"><a href="?module=admin&amp;page=index&amp;url_rewrite=&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;sidebar_type=collapsible&amp;sidebar-sticky=false&amp;top-sticky=false&amp;lang=en" title="English"><img src="<?php echo site_url('common/theme/images/lang/en.png')?>" alt="English"> English</a></li>
			      		<li><a href="?module=admin&amp;page=index&amp;url_rewrite=&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;sidebar_type=collapsible&amp;sidebar-sticky=false&amp;top-sticky=false&amp;lang=ro" title="Romanian"><img src="<?php echo site_url('common/theme/images/lang/ro.png')?>" alt="Romanian"> Romanian</a></li>
			      		<li><a href="?module=admin&amp;page=index&amp;url_rewrite=&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;sidebar_type=collapsible&amp;sidebar-sticky=false&amp;top-sticky=false&amp;lang=it" title="Italian"><img src="<?php echo site_url('common/theme/images/lang/it.png')?>" alt="Italian"> Italian</a></li>
			      		<li><a href="?module=admin&amp;page=index&amp;url_rewrite=&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;sidebar_type=collapsible&amp;sidebar-sticky=false&amp;top-sticky=false&amp;lang=fr" title="French"><img src="<?php echo site_url('common/theme/images/lang/fr.png')?>" alt="French"> French</a></li>
			      		<li><a href="?module=admin&amp;page=index&amp;url_rewrite=&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;sidebar_type=collapsible&amp;sidebar-sticky=false&amp;top-sticky=false&amp;lang=pl" title="Polish"><img src="<?php echo site_url('common/theme/images/lang/pl.png')?>" alt="Polish"> Polish</a></li>
			    	</ul>
				</li>
				<!-- // Language menu END -->
				...
				<li class="account dropdown dd-1">
										<a data-toggle="dropdown" href="my_account_advanced.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible" class="glyphicons logout lock"><span class="hidden-md hidden-sm hidden-desktop-1">mosaicpro</span><i></i></a>
					<ul class="dropdown-menu pull-right">
						<li><a href="my_account_advanced.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible" class="glyphicons cogwheel">Settings<i></i></a></li>
						<li><a href="my_account_advanced.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible" class="glyphicons camera">My Photos<i></i></a></li>
						<li class="profile">
							<span>
								<span class="heading">Profile <a href="my_account_advanced.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible" class="pull-right text-primary text-weight-regular">edit</a></span>
								<a href="my_account_advanced.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible" class="img thumb">
									<img src="<?php echo site_url('common/theme/images/avatar-51x51.jpg')?>" alt="Avatar" />
								</a>
								<span class="details">
									<a href="my_account_advanced.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible" class="strong text-regular">Mosaic Pro</a>
...
<div class="heading-buttons">
	...
	<div class="buttons">
		<a href="google_analytics.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-default-menus-dark&amp;top-sticky=false&amp;sidebar-sticky=false&amp;sidebar_type=collapsible" class="btn btn-primary">Google Analytics API</a>
	</div>
	<div class="clearfix"></div>
</div>
...
<div class="innerLR innerB">
	...
	<div class="row">
		...
		<div id="footer" class="hidden-print">
			...
			<!--  Copyright Line -->
			<div class="copy">&copy; 2012 - 2013 - <a href="http://www.mosaicpro.biz">MosaicPro</a> - All Rights Reserved. <a href="http://themeforest.net/?ref=mosaicpro" target="_blank">Purchase FLAT KIT on ThemeForest</a> - Current version: v2.0.0 / <a target="_blank" href="http://demo.mosaicpro.biz/flatkit/CHANGELOG">changelog</a></div>
			<!--  End Copyright Line -->
...
<!-- // Themer END -->
	...
	<!-- Holder Plugin -->
	<script src="<?php echo site_url('common/theme/scripts/plugins/other/holder/holder.js?1382019475')?>"></script>
	
	<!-- Uniform Forms Plugin -->
	<script src="<?php echo site_url('common/theme/scripts/plugins/forms/pixelmatrix-uniform/jquery.uniform.min.js')?>"></script>
	
	<!-- MegaMenu -->
	<script src="<?php echo site_url('common/theme/scripts/demo/megamenu.js?1382019475')?>"></script>

	<!-- Bootstrap Extended -->
	<script src="<?php echo site_url('common/bootstrap/extend/bootstrap-select/bootstrap-select.js')?>"></script>
	<script src="<?php echo site_url('common/bootstrap/extend/bootstrap-switch/static/js/bootstrap-switch.js')?>"></script>
	<script src="<?php echo site_url('common/bootstrap/extend/jasny-fileupload/js/bootstrap-fileupload.js')?>"></script>
	<script src="<?php echo site_url('common/bootstrap/extend/bootbox.js')?>"></script>
	<script src="<?php echo site_url('common/bootstrap/extend/bootstrap-wysihtml5/js/wysihtml5-0.3.0_rc2.min.js')?>"></script>
	<script src="<?php echo site_url('common/bootstrap/extend/bootstrap-wysihtml5/js/bootstrap-wysihtml5-0.0.2.js')?>"></script>
	...
	<!-- MiniColors Plugin -->
	<script src="<?php echo site_url('common/theme/scripts/plugins/color/jquery-miniColors/jquery.miniColors.js')?>"></script>
	...
	<!-- Cookie Plugin -->
	<script src="<?php echo site_url('common/theme/scripts/plugins/system/jquery.cookie.js')?>"></script>
	
	<!-- Select2 Plugin -->
	<script src="<?php echo site_url('common/theme/scripts/plugins/forms/select2/select2.js')?>"></script>
	...
	<script src="<?php echo site_url('common/theme/scripts/plugins/charts/sparkline/jquery.sparkline.min.js')?>"></script>
	
	<!-- Ba-Resize Plugin -->
	<script src="<?php echo site_url('common/theme/scripts/plugins/other/jquery.ba-resize.js')?>"></script>
	
	
	<!--  Flot Charts Plugin -->
	<script src="<?php echo site_url('common/theme/scripts/plugins/charts/flot/jquery.flot.js')?>"></script>
	<script src="<?php echo site_url('common/theme/scripts/plugins/charts/flot/jquery.flot.pie.js')?>"></script>
	<script src="<?php echo site_url('common/theme/scripts/plugins/charts/flot/jquery.flot.tooltip.js')?>"></script>
	<script src="<?php echo site_url('common/theme/scripts/plugins/charts/flot/jquery.flot.selection.js')?>"></script>
	<script src="<?php echo site_url('common/theme/scripts/plugins/charts/flot/jquery.flot.resize.js')?>"></script>
	<script src="<?php echo site_url('common/theme/scripts/plugins/charts/flot/jquery.flot.orderBars.js')?>"></script>
	
	<!-- Charts Helper Demo Script -->
	<script src="<?php echo site_url('common/theme/scripts/demo/charts.helper.js?1382019475')?>"></script>
	...
	<script src="<?php echo site_url('common/theme/scripts/demo/index.js?1382019475')?>"></script>
